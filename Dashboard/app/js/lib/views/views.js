...
require('akvo-flow/views/maps/cartodb-maps-common');
require('akvo-flow/views/maps/cartodb-data-map-view');
require('akvo-flow/views/maps/cartodb-custom-maps-list-view');
require('akvo-flow/views/maps/cartodb-custom-map-edit-view');
require('akvo-flow/views/maps/cartodb-custom-map-view');
...
// custom maps views
FLOW.NavCartodbMapsView = Ember.View.extend({
...
// ********************************************************//
FLOW.CartodbMapsSubnavView = Em.View.extend({
